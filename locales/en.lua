local Translations = {
    ...
    info = {
        ...
        sd_hospital = 'Sandy Shores Hospital',
        sc1_hospital = 'City Secret Hospital',
        sc2_hospital = 'Sandy Secret Hospital',
        sc3_hospital = 'Paleto Secret Hospital',
        sc4_hospital = 'Cayo Perico Secret Hospital',
        paleto_hospital = 'Paleto Hospital',
        cayoperico_hospital = 'Cayo Perico Hospital',
